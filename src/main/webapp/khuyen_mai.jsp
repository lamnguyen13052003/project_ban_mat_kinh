                    ...
                    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar"
                        ...
                        <div class="offcanvas-body">
                            <ul class="navbar-nav m-auto">
                                ...
                                <li class="nav-item dropdown pe-lg-5 pe-md-0">
                                    <a href="khuyen_mai.html" class="nav-link px-4 rounded active">Khuyến mãi</a>
                                </li>
                                <li class="nav-item dropdown pe-lg-5 pe-md-0">
        ...
        <div id="carouselExampleIndicators" class="carousel slide mb-5">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="images/img_slide/slideShow_1.png" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
                    <img src="images/img_slide/slideShow_2.png" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
                    <img src="images/img_slide/slideShow_3.jpg" class="d-block w-100" alt="...">
                </div>
            </div>
                    ...
                    <div class="pro-loop col rounded-3">
                        ...
                        <div class="pro-loop-wrap position-relative">
                            ...
                            <div class="pro-loop-image position-relative">
                                ...
                                <!--Hiển thị hình ảnh-->
                                <a href="product/thong_tin_san_pham.jsp" class="pro-loop-image-item d-block">
                            ...
                            <h3 class="pro-loop-name text-center">
                                <a href="product/thong_tin_san_pham.jsp" title="Tên sản phẩm">Tên sản phẩm</a>
                            </h3>
...
<script src="javascript/khuyen_mai.js"></script>
