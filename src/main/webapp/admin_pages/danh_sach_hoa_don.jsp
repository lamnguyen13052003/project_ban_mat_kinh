                    ...
                    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbarAdmin"
                        ...
                        <div class="offcanvas-body">
                            <ul class="navbar-nav m-auto">
                                ...
                                <li class="nav-item dropdown pe-lg-5 pe-md-0">
                                    <a href="danh_sach_hoa_don.html" class="nav-link px-4 rounded active">Danh sách hóa
                                        đơn</a>
                                </li>
                            </ul>
                        </div>
    ...
    <div class="container ">
        ...
        <div class="show-list-bill p-0">
            ...
            <div class="list-bill">
                ...
                <!-- bắt đầu một hàng hiện thị sản phẩm-->
                <div class="item-bill row  align-items-center py-md-3 ps-4" value="Nguyễn Đình B">
                    <div class="id-item col-2"><span>#12345</span></div>
                    <div class="time-order col-2"><span>dd/mm/yy, </span><span>hh:mm</span></div>
                    <div class="col-3 d-flex">
                        <div class="avatar-customer">
                ...
                <!-- bắt đầu một hàng hiện thị sản phẩm-->
                <div class="item-bill row  align-items-center py-md-3 ps-4" value="Nguyễn Đình C">
                    <div class="id-item col-2"><span>#12345</span></div>
                    <div class="time-order col-2"><span>dd/mm/yy, </span><span>hh:mm</span></div>
                    <div class="col-3 d-flex">
                        <div class="avatar-customer">
                ...
                <!-- bắt đầu một hàng hiện thị sản phẩm-->
                <div class="item-bill row  align-items-center py-md-3 ps-4" value="Nguyễn Đình ">
                    <div class="id-item col-2"><span>#12345</span></div>
                    <div class="time-order col-2"><span>dd/mm/yy, </span><span>hh:mm</span></div>
                    <div class="col-3 d-flex">
                        <div class="avatar-customer">
...
<script src="../javascript/danh_sach_hoa_don.js"></script>
