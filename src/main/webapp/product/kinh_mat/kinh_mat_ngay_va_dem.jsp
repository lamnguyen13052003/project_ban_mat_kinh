                                ...
                                <li class="nav-item dropdown pe-lg-5 pe-md-0">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a class="dropdown-item" href="kinh_mat_nu.jsp">Kính mát
                                            nữ</a></li>
                                        <li><a class="dropdown-item" href="kinh_mat_ngay_va_dem.html">Kính
                                            đi ngày và đêm</a></li>
                    ...
                    <div class="pro-loop col rounded-3">
                        ...
                        <div class="pro-loop-wrap position-relative">
                                ...
                                <a href="/products/kinh-mat-gap-tron-oem-2015" class="pro-loop-image-item d-block">
                                    ...
                                    <picture class="img-hidden-when-hover">
                                        <img class="lazyloaded  rounded-3"
                                             src="../../images/product/kinh_mat/ngaydem1_double-shield-70015.png"
                                             alt=" Kính Mát Bộ 2 Tròng Tháo Lắp Double Shield 70015 ">
                                    </picture>
                                    <!--Ảnh khi horver vào phẩn "Ô hiển thị"-->
                                    <picture class="img-show-when-hover">
                                        <img class="lazyloaded  rounded-3"
                                             src="../../images/thong_tin_san_pham_kinh_mat/img/ngaydem1_double-shield-70015_hover.png"
                                             alt=" Kính Mát Bộ 2 Tròng Tháo Lắp Double Shield 70015 ">
                                    </picture>
                                </a>
                            </div>
                            ...
                            <div class="pro-loop-brand text-center">
                                <span class="pro-loop-vendor d-block">Double Shield</span>
                            </div>

                            <!--Hiển thị tên sản phẩm-->
                            <h3 class="pro-loop-name text-center">
                                <a href="/products/kinh-mat-gap-tron-oem-2015"
                                   title="Kính Mát Bộ 2 Tròng Tháo Lắp Double Shield 70015">Kính Mát Bộ 2 Tròng Tháo Lắp
                                    Double Shield 70015</a>
                            </h3>
                        ...
                        <div class="pro-loop-wrap position-relative">
                            ...
                            <div class="pro-loop-image position-relative">
                                ...
                                <a href="/products/kinh-mat-gap-tron-oem-2015" class="pro-loop-image-item d-block">
                                    ...
                                    <picture class="img-hidden-when-hover">
                                        <img class="lazyloaded  rounded-3"
                                             src="../../images/product/kinh_mat/ngaydem2_irma-ir3043ry.png"
                                             alt=" Kính Mát Đi Ngày Và Đêm IRMA IR3043RY ">
                                    </picture>
                                    <!--Ảnh khi horver vào phẩn "Ô hiển thị"-->
                                    <picture class="img-show-when-hover">
                                        <img class="lazyloaded  rounded-3"
                                             src="../../images/product/kinh_mat/ngaydem2_irma-ir3043ry_hover.png"
                                             alt=" Kính Mát Đi Ngày Và Đêm IRMA IR3043RY ">
                                    </picture>
                                </a>
                            </div>
                            ...
                            <!--Hiển thị tên thương hiệu-->
                            <div class="pro-loop-brand text-center">
                                <span class="pro-loop-vendor d-block">IRMA</span>
                            </div>

                            <!--Hiển thị tên sản phẩm-->
                            <h3 class="pro-loop-name text-center">
                                <a href="/products/kinh-mat-gap-tron-oem-2015"
                                   title="Kính Mát Đi Ngày Và Đêm IRMA IR3043RY">Kính Mát Đi Ngày Và Đêm IRMA
                                    IR3043RY</a>
                            </h3>
                            ...
                            <!--hiển thị giá-->
                            <div class="pro-loop-price text-center mt-0">
                                <p class="fw-bold d-inline me-3">440,000 <span> ₫</span></p>
                                <del><span> </span></del>
                            </div>
                        ...
                        <div class="pro-loop-wrap position-relative">
                            ...
                            <div class="pro-loop-image position-relative">
                                ...
                                <a href="/products/kinh-mat-gap-tron-oem-2015" class="pro-loop-image-item d-block">
                                    ...
                                    <picture class="img-hidden-when-hover">
                                        <img class="lazyloaded  rounded-3"
                                             src="../../images/product/kinh_mat/ngaydem3_lapola-a663_den.png"
                                             alt=" Kính Mát Phân Cực Lapola A663 ">
                                    </picture>
                                    <!--Ảnh khi horver vào phẩn "Ô hiển thị"-->
                                    <picture class="img-show-when-hover">
                                        <img class="lazyloaded  rounded-3"
                                             src="../../images/product/kinh_mat/ngaydem3_lapola-a663_vang.png"
                                             alt=" Kính Mát Phân Cực Lapola A663 ">
                                    </picture>
                                </a>
                            </div>
                            ...
                            <!--Hiển thị tên thương hiệu-->
                            <div class="pro-loop-brand text-center">
                                <span class="pro-loop-vendor d-block">AORON</span>
                            </div>

                            <!--Hiển thị tên sản phẩm-->
                            <h3 class="pro-loop-name text-center">
                                <a href="/products/kinh-mat-gap-tron-oem-2015" title="Kính Mát Phân Cực Lapola A663">Kính
                                    Mát Phân Cực Lapola A663m</a>
                            </h3>
                        ...
                        <div class="pro-loop-wrap position-relative">
                            ...
                            <div class="pro-loop-image position-relative">
                                ...
                                <a href="/products/kinh-mat-gap-tron-oem-2015" class="pro-loop-image-item d-block">
                                    ...
                                    <picture class="img-hidden-when-hover">
                                        <img class="lazyloaded  rounded-3"
                                             src="../../images/product/kinh_mat/ngaydem4_zola-a651_C1den.png"
                                             alt=" Kính Mát Phân Cực Zola A651 ">
                                    </picture>
                                    <!--Ảnh khi horver vào phẩn "Ô hiển thị"-->
                                    <picture class="img-show-when-hover">
                                        <img class="lazyloaded  rounded-3"
                                             src="../../images/product/kinh_mat/ngaydem4_zola-a651_C4.png"
                                             alt=" Kính Mát Phân Cực Zola A651 ">
                                    </picture>
                                </a>
                            </div>
                            ...
                            <!--Hiển thị tên sản phẩm-->
                            <h3 class="pro-loop-name text-center">
                                <a href="/products/kinh-mat-gap-tron-oem-2015" title="Kính Mát Phân Cực Zola A651">Kính
                                    Mát Phân Cực Zola A651</a>
                            </h3>


                            <!--hiển thị giá-->
                            <div class="pro-loop-price text-center mt-0">
                                <p class="fw-bold d-inline me-3">600,000<span> ₫</span></p>
                                <del><span> </span></del>
                            </div>
                        ...
                        <div class="pro-loop-wrap position-relative">
                            ...
                            <div class="pro-loop-image position-relative">
                                ...
                                <a href="/products/kinh-mat-gap-tron-oem-2015" class="pro-loop-image-item d-block">
                                    ...
                                    <picture class="img-hidden-when-hover">
                                        <img class="lazyloaded  rounded-3"
                                             src="../../images/product/kinh_mat/ngaydem5_sokex.png"
                                             alt=" Kính mát SOLEX Hồng Kong Cao cấp đi Ngày và Đêm ">
                                    </picture>
                                    <!--Ảnh khi horver vào phẩn "Ô hiển thị"-->
                                    <picture class="img-show-when-hover">
                                        <img class="lazyloaded  rounded-3"
                                             src="../../images/product/kinh_mat/ngaydem5_sokex_hover.png"
                                             alt=" Kính mát SOLEX Hồng Kong Cao cấp đi Ngày và Đêm ">
                                    </picture>
                                </a>
                            </div>
                            ...
                            <!--Hiển thị tên thương hiệu-->
                            <div class="pro-loop-brand text-center">
                                <span class="pro-loop-vendor d-block">OEM</span>
                            </div>

                            <!--Hiển thị tên sản phẩm-->
                            <h3 class="pro-loop-name text-center">
                                <a href="/products/kinh-mat-gap-tron-oem-2015"
                                   title="Kính mát SOLEX Hồng Kong Cao cấp đi Ngày và Đêm">Kính mát SOLEX Hồng Kong Cao
                                    cấp đi Ngày và Đêm</a>
                            </h3>


                            <!--hiển thị giá-->
                            <div class="pro-loop-price text-center mt-0">
                                <p class="fw-bold d-inline me-3"> 390,000 <span> ₫</span></p>
                                <del>460,000 <span> ₫</span></del>
                            </div>
                        ...
                        <div class="pro-loop-wrap position-relative">
                            ...
                            <div class="pro-loop-image position-relative">
                                ...
                                <a href="/products/kinh-mat-gap-tron-oem-2015" class="pro-loop-image-item d-block">
                                    ...
                                    <picture class="img-hidden-when-hover">
                                        <img class="lazyloaded  rounded-3"
                                             src="../../images/product/kinh_mat/ngaydem6_a8177g.png"
                                             alt=" Kính mát SOLEX Hồng Kong Cao cấp đi Ngày và Đêm ">
                                    </picture>
                                    <!--Ảnh khi horver vào phẩn "Ô hiển thị"-->
                                    <picture class="img-show-when-hover">
                                        <img class="lazyloaded  rounded-3"
                                             src="../../images/product/kinh_mat/ngaydem6_a8177g_hover.png"
                                             alt=" Kính mát SOLEX Hồng Kong Cao cấp đi Ngày và Đêm ">
                                    </picture>
                                </a>
                            </div>
                            ...
                            <!--Hiển thị tên thương hiệu-->
                            <div class="pro-loop-brand text-center">
                                <span class="pro-loop-vendor d-block">X+Aviator</span>
                            </div>
                            ...
                            <!--hiển thị giá-->
                            <div class="pro-loop-price text-center mt-0">
                                <p class="fw-bold d-inline me-3">239,000 <span> ₫</span></p>
                        ...
                        <div class="pro-loop-wrap position-relative">
                            ...
                            <div class="pro-loop-image position-relative">
                                ...
                                <a href="/products/kinh-mat-gap-tron-oem-2015" class="pro-loop-image-item d-block">
                                    ...
                                    <picture class="img-hidden-when-hover">
                                        <img class="lazyloaded  rounded-3"
                                             src="../../images/product/kinh_mat/ngaydem7_dky8503dm.png"
                                             alt=" Mắt kính mát nam nữ đổi màu dùng cả ngày và đêm, tròng Polaroid phân cực ">
                                    </picture>
                                    <!--Ảnh khi horver vào phẩn "Ô hiển thị"-->
                                    <picture class="img-show-when-hover">
                                        <img class="lazyloaded  rounded-3"
                                             src="../../images/product/kinh_mat/ngaydem7_dky8503dm_hover.png"
                                             alt=" Mắt kính mát nam nữ đổi màu dùng cả ngày và đêm, tròng Polaroid phân cực ">
                                    </picture>
                                </a>
                            </div>
                            ...
                            <!--Hiển thị tên thương hiệu-->
                            <div class="pro-loop-brand text-center">
                                <span class="pro-loop-vendor d-block">DKY</span>
                            </div>

                            <!--Hiển thị tên sản phẩm-->
                            <h3 class="pro-loop-name text-center">
                                <a href="/products/kinh-mat-gap-tron-oem-2015"
                                   title="Mắt kính mát nam nữ đổi màu dùng cả ngày và đêm, tròng Polaroid phân cực">Mắt
                                    kính mát nam nữ đổi màu dùng cả ngày và đêm, tròng Polaroid phân cực</a>
                            </h3>


                            <!--hiển thị giá-->
                            <div class="pro-loop-price text-center mt-0">
                                <p class="fw-bold d-inline me-3">269,000 <span> ₫</span></p>
                                <del><span> </span></del>
                            </div>
                        ...
                        <div class="pro-loop-wrap position-relative">
                            ...
                            <div class="pro-loop-image position-relative">
                                ...
                                <a href="/products/kinh-mat-gap-tron-oem-2015" class="pro-loop-image-item d-block">
                                    ...
                                    <picture class="img-hidden-when-hover">
                                        <img class="lazyloaded  rounded-3"
                                             src="../../images/product/kinh_mat/ngaydem8_7k0540dm.png"
                                             alt=" Mắt kính mát nam đổi màu đi ngày đêm 7K0540DM ">
                                    </picture>
                                    <!--Ảnh khi horver vào phẩn "Ô hiển thị"-->
                                    <picture class="img-show-when-hover">
                                        <img class="lazyloaded  rounded-3"
                                             src="../../images/product/kinh_mat/ngaydem8_7k0540dm_hover.png"
                                             alt=" Mắt kính mát nam đổi màu đi ngày đêm 7K0540DM ">
                                    </picture>
                                </a>
                            </div>
                            ...
                            <!--Hiển thị tên thương hiệu-->
                            <div class="pro-loop-brand text-center">
                                <span class="pro-loop-vendor d-block">7k</span>
                            </div>

                            <!--Hiển thị tên sản phẩm-->
                            <h3 class="pro-loop-name text-center">
                                <a href="/products/kinh-mat-gap-tron-oem-2015"
                                   title="Mắt kính mát nam đổi màu đi ngày đêm 7K0540DM">Mắt kính mát nam đổi màu đi
                                    ngày đêm 7K0540DM</a>
                            </h3>
                            ...
                            <!--hiển thị giá-->
                            <div class="pro-loop-price text-center mt-0">
                                <p class="fw-bold d-inline me-3">279,000 <span> ₫</span></p>
                                <del><span> </span></del>
                            </div>
                        ...
                        <div class="pro-loop-wrap position-relative">
                            ...
                            <div class="pro-loop-image position-relative">
                                ...
                                <a href="/products/kinh-mat-gap-tron-oem-2015" class="pro-loop-image-item d-block">
                                    ...
                                    <picture class="img-hidden-when-hover">
                                        <img class="lazyloaded  rounded-3"
                                             src="../../images/product/kinh_mat/ngaydem9_ak050-aoron.png"
                                             alt=" Kính Mát Nam Đi Ngày Đêm AK050-Aoron ">
                                    </picture>
                                    <!--Ảnh khi horver vào phẩn "Ô hiển thị"-->
                                    <picture class="img-show-when-hover">
                                        <img class="lazyloaded  rounded-3"
                                             src="../../images/product/kinh_mat/ngaydem9_ak050-aoron_hover.png"
                                             alt="Kính Mát Nam Đi Ngày Đêm AK050-Aoron ">
                                    </picture>
                                </a>
                            </div>
                            ...
                            <h3 class="pro-loop-name text-center">
                                <a href="/products/kinh-mat-gap-tron-oem-2015"
                                   title="Kính Mát Nam Đi Ngày Đêm AK050-Aoron">Kính Mát Nam Đi Ngày Đêm AK050-Aoron</a>
                            </h3>


                            <!--hiển thị giá-->
                            <div class="pro-loop-price text-center mt-0">
                                <p class="fw-bold d-inline me-3">260,000 <span> ₫</span></p>
                                <del><span> </span></del>
                            </div>
                        ...
                        <div class="pro-loop-wrap position-relative">
                            ...
                            <div class="pro-loop-image position-relative">
                                ...
                                <a href="/products/kinh-mat-gap-tron-oem-2015" class="pro-loop-image-item d-block">
                                    ...
                                    <picture class="img-hidden-when-hover">
                                        <img class="lazyloaded  rounded-3"
                                             src="../../images/product/kinh_mat/ngaydem10_magie10-aoron_gong-xam-mat-vang.png"
                                             alt=" Kính Mát Nam Nữ Đi Ngày Và Đêm Magie AK010 - AORON ">
                                    </picture>
                                    <!--Ảnh khi horver vào phẩn "Ô hiển thị"-->
                                    <picture class="img-show-when-hover">
                                        <img class="lazyloaded  rounded-3"
                                             src="../../images/product/kinh_mat/ngaydem10_magie10-aoron_gong-xam-mat-xanh-duong.png"
                                             alt=" Kính Mát Nam Nữ Đi Ngày Và Đêm Magie AK010 - AORON ">
                                    </picture>
                                </a>
                            </div>
                            ...
                            <h3 class="pro-loop-name text-center">
                                <a href="/products/kinh-mat-gap-tron-oem-2015"
                                   title="Kính Mát Nam Nữ Đi Ngày Và Đêm Magie AK010 - AORON">Kính Mát Nam Nữ Đi Ngày Và
                                    Đêm Magie AK010 - AORON</a>
                            </h3>
                        ...
                        <div class="pro-loop-wrap position-relative">
                            ...
                            <div class="pro-loop-image position-relative">
                                ...
                                <a href="/products/kinh-mat-gap-tron-oem-2015" class="pro-loop-image-item d-block">
                                    ...
                                    <picture class="img-hidden-when-hover">
                                        <img class="lazyloaded  rounded-3"
                                             src="../../images/product/kinh_mat/ngaydem11_7k570dm.png"
                                             alt=" Mắt kính mát nam đổi màu gấp gọn, đi ngày đêm DKYRBGV ">
                                    </picture>
                                    <!--Ảnh khi horver vào phẩn "Ô hiển thị"-->
                                    <picture class="img-show-when-hover">
                                        <img class="lazyloaded  rounded-3"
                                             src="../../images/product/kinh_mat/ngaydem11_7k570dm_hover.png"
                                             alt=" Mắt kính mát nam đổi màu gấp gọn, đi ngày đêm DKYRBGV ">
                                    </picture>
                                </a>
                            </div>
                            ...
                            <h3 class="pro-loop-name text-center">
                                <a href="/products/kinh-mat-gap-tron-oem-2015"
                                   title="Mắt kính mát nam đổi màu gấp gọn, đi ngày đêm DKYRBGV">Mắt kính mát nam đổi
                                    màu gấp gọn, đi ngày đêm DKYRBGV</a>
                            </h3>
                        ...
                        <div class="pro-loop-wrap position-relative">
                            ...
                            <div class="pro-loop-image position-relative">
                                ...
                                <a href="/products/kinh-mat-gap-tron-oem-2015" class="pro-loop-image-item d-block">
                                    ...
                                    <picture class="img-hidden-when-hover">
                                        <img class="lazyloaded  rounded-3"
                                             src="../../images/product/kinh_mat/ngaydem12_dkyrbgv.png"
                                             alt=" Mắt kính mát nam đổi màu gấp gọn, đi ngày đêm DKYRBGV ">
                                    </picture>
                                    <!--Ảnh khi horver vào phẩn "Ô hiển thị"-->
                                    <picture class="img-show-when-hover">
                                        <img class="lazyloaded  rounded-3"
                                             src="../../images/product/kinh_mat/ngaydem12_dkyrbgv_hover.png"
                                             alt=" Mắt kính mát nam đổi màu gấp gọn, đi ngày đêm DKYRBGV ">
                                    </picture>
                                </a>
                            </div>
