                        ...
                        <div class="offcanvas-body">
                            <ul class="navbar-nav m-auto">
                                <li class="nav-item dropdown pe-lg-5 pe-md-0">
                                    <a href="kinh_mat.jsp" class="nav-link dropdown-toggle px-4 rounded active"
                                       type="button">
                                        <span>Kính mát</span>
                                    </a>
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item" href="kinh_mat_nam.jsp">Kính mát
                                            nam</a></li>
                                        <li><a class="dropdown-item" href="kinh_mat_nu.jsp">Kính mát
                                            nữ</a></li>
                                        <li><a class="dropdown-item" href="kinh_mat_ngay_va_dem.jsp">Kính
                                            đi ngày và đêm</a></li>
                                        <li><a class="dropdown-item" href="kinh_doi_mau.jsp">Kính đổi
                                            màu</a></li>
                                        <li><a class="dropdown-item"
                                               href="kinh_loc_anh_sang_xanh.jsp">Kính lọc ánh sáng
                                            xanh</a></li>
                                        <li><a class="dropdown-item"
                                               href="kinh_mat_clip_on_hai_lop.html">Kính Mắt Clip on 2
                                            Lớp</a></li>
                                    </ul>
                                </li>
                                <li class="nav-item dropdown pe-lg-5 pe-md-0">
        ...
        <div class="content collection-wrap">
            ...
            <section class="collection-wrap-product-list mt-5">
                <div class="title mb-3">
                    <h3>Kính mát clip on hai lớp</h3>
                </div>
                    ...
                    <div class="pro-loop col rounded-3">
                        ...
                        <div class="pro-loop-wrap position-relative">
                                ...
                                <a href="/products/kinh-mat-gap-tron-oem-2015" class="pro-loop-image-item d-block">
                                    ...
                                    <picture class="img-hidden-when-hover">
                                        <img class="lazyloaded  rounded-3"
                                             src="../../images/product/kinh_mat/clipon1_polarized-12149.png"
                                             alt=" Kính Râm Cận TR90 Clip On Phân Cực Polarized 2 Trong 1 Bộ 5 Kẹp Cao Cấp 12149 ">
                                    </picture>
                                    <!--Ảnh khi horver vào phẩn "Ô hiển thị"-->
                                    <picture class="img-show-when-hover">
                                        <img class="lazyloaded  rounded-3"
                                             src="../../images/product/kinh_mat/clipon1_polarized-12149_hover.png"
                                             alt=" Kính Râm Cận TR90 Clip On Phân Cực Polarized 2 Trong 1 Bộ 5 Kẹp Cao Cấp 12149 ">
                                    </picture>
                                </a>
                            </div>
                            ...
                            <div class="pro-loop-brand text-center">
                                <span class="pro-loop-vendor d-block">Snap Lens</span>
                            </div>

                            <!--Hiển thị tên sản phẩm-->
                            <h3 class="pro-loop-name text-center">
                                <a href="/products/kinh-mat-gap-tron-oem-2015"
                                   title="Kính Râm Cận TR90 Clip On Phân Cực Polarized 2 Trong 1 Bộ 5 Kẹp Cao Cấp 12149">Kính
                                    Râm Cận TR90 Clip On Phân Cực Polarized 2 Trong 1 Bộ 5 Kẹp Cao Cấp 12149</a>
                            </h3>


                            <!--hiển thị giá-->
                            <div class="pro-loop-price text-center mt-0">
                                <p class="fw-bold d-inline me-3">300,000 <span> ₫</span></p>
                                <del>800,000 <span> ₫</span></del>
                            </div>
                        ...
                        <div class="pro-loop-wrap position-relative">
                            ...
                            <div class="pro-loop-image position-relative">
                                ...
                                <a href="/products/kinh-mat-gap-tron-oem-2015" class="pro-loop-image-item d-block">
                                    ...
                                    <picture class="img-hidden-when-hover">
                                        <img class="lazyloaded  rounded-3"
                                             src="../../images/product/kinh_mat/clipon2_polarized-TJ2186.png"
                                             alt=" Kính Râm Cận Tròn TR90 Clip On Phân Cực Polarized 2 Trong 1 TJ2186 ">
                                    </picture>
                                    <!--Ảnh khi horver vào phẩn "Ô hiển thị"-->
                                    <picture class="img-show-when-hover">
                                        <img class="lazyloaded  rounded-3"
                                             src="../../images/product/kinh_mat/clipon2_polarized-TJ2186_hover.png"
                                             alt=" Kính Râm Cận Tròn TR90 Clip On Phân Cực Polarized 2 Trong 1 TJ2186 ">
                                    </picture>
                                </a>
                            </div>
                            ...
                            <h3 class="pro-loop-name text-center">
                                <a href="/products/kinh-mat-gap-tron-oem-2015"
                                   title="Kính Râm Cận Tròn TR90 Clip On Phân Cực Polarized 2 Trong 1 TJ2186">Kính Râm
                                    Cận Tròn TR90 Clip On Phân Cực Polarized 2 Trong 1 TJ2186</a>
                            </h3>


                            <!--hiển thị giá-->
                            <div class="pro-loop-price text-center mt-0">
                                <p class="fw-bold d-inline me-3">400,000 <span> ₫</span></p>
                                <del>800,000 <span> ₫</span></del>
                            </div>
                        ...
                        <div class="pro-loop-wrap position-relative">
                            ...
                            <div class="pro-loop-image position-relative">
                                ...
                                <a href="/products/kinh-mat-gap-tron-oem-2015" class="pro-loop-image-item d-block">
                                    ...
                                    <picture class="img-hidden-when-hover">
                                        <img class="lazyloaded  rounded-3"
                                             src="../../images/product/kinh_mat/clipon3_baggio-CG7703_C01-P97-den.png"
                                             alt=" Kính Râm Cận Clip On 2 Trong 1 Baggio CG7703 ">
                                    </picture>
                                    <!--Ảnh khi horver vào phẩn "Ô hiển thị"-->
                                    <picture class="img-show-when-hover">
                                        <img class="lazyloaded  rounded-3"
                                             src="../../images/product/kinh_mat/clipon3_baggio-CG7703_C26-P120-trong.png"
                                             alt=" Kính Râm Cận Clip On 2 Trong 1 Baggio CG7703 ">
                                    </picture>
                                </a>
                            </div>
                            ...
                            <!--Hiển thị tên thương hiệu-->
                            <div class="pro-loop-brand text-center">
                                <span class="pro-loop-vendor d-block">Baggio</span>
                            </div>

                            <!--Hiển thị tên sản phẩm-->
                            <h3 class="pro-loop-name text-center">
                                <a href="/products/kinh-mat-gap-tron-oem-2015"
                                   title="Kính Râm Cận Clip On 2 Trong 1 Baggio CG7703">Kính Râm Cận Clip On 2 Trong 1
                                    Baggio CG7703</a>
                            </h3>
                            ...
                            <!--hiển thị giá-->
                            <div class="pro-loop-price text-center mt-0">
                                <p class="fw-bold d-inline me-3">680,000 <span> ₫</span></p>
                                <del><span> </span></del>
                            </div>
                        ...
                        <div class="pro-loop-wrap position-relative">
                            ...
                            <div class="pro-loop-image position-relative">
                                ...
                                <a href="/products/kinh-mat-gap-tron-oem-2015" class="pro-loop-image-item d-block">
                                    ...
                                    <picture class="img-hidden-when-hover">
                                        <img class="lazyloaded  rounded-3"
                                             src="../../images/product/kinh_mat/clipon4_polarized-2269.png"
                                             alt=" Kính Thể Thao Râm Cận TR90 Clip On Phân Cực Polarized 2 Trong 1 Bộ 5 Kẹp Cao Cấp TR 2269 ">
                                    </picture>
                                    <!--Ảnh khi horver vào phẩn "Ô hiển thị"-->
                                    <picture class="img-show-when-hover">
                                        <img class="lazyloaded  rounded-3"
                                             src="../../images/product/kinh_mat/clipon4_polarized-2269_hover.png"
                                             alt=" Kính Thể Thao Râm Cận TR90 Clip On Phân Cực Polarized 2 Trong 1 Bộ 5 Kẹp Cao Cấp TR 2269 ">
                                    </picture>
                                </a>
                            </div>
                            ...
                            <h3 class="pro-loop-name text-center">
                                <a href="/products/kinh-mat-gap-tron-oem-2015"
                                   title="Kính Thể Thao Râm Cận TR90 Clip On Phân Cực Polarized 2 Trong 1 Bộ 5 Kẹp Cao Cấp TR 2269">Kính
                                    Thể Thao Râm Cận TR90 Clip On Phân Cực Polarized 2 Trong 1 Bộ 5 Kẹp Cao Cấp TR
                                    2269</a>
                            </h3>
                        ...
                        <div class="pro-loop-wrap position-relative">
                            ...
                            <div class="pro-loop-image position-relative">
                                ...
                                <a href="/products/kinh-mat-gap-tron-oem-2015" class="pro-loop-image-item d-block">
                                    ...
                                    <picture class="img-hidden-when-hover">
                                        <img class="lazyloaded  rounded-3"
                                             src="../../images/product/kinh_mat/clipon5_polarized-2218T.png"
                                             alt=" Kính Râm Cận TR90 Clip On Phân Cực Polarized 2 Trong 1 Bộ 5 Kẹp Cao Cấp 2218T ">
                                    </picture>
                                    <!--Ảnh khi horver vào phẩn "Ô hiển thị"-->
                                    <picture class="img-show-when-hover">
                                        <img class="lazyloaded  rounded-3"
                                             src="../../images/product/kinh_mat/clipon5_polarized-2218T_cover.png"
                                             alt=" Kính Râm Cận TR90 Clip On Phân Cực Polarized 2 Trong 1 Bộ 5 Kẹp Cao Cấp 2218T ">
                                    </picture>
                                </a>
                            </div>
                            ...
                            <h3 class="pro-loop-name text-center">
                                <a href="/products/kinh-mat-gap-tron-oem-2015"
                                   title="Kính Râm Cận TR90 Clip On Phân Cực Polarized 2 Trong 1 Bộ 5 Kẹp Cao Cấp 2218T">Kính
                                    Râm Cận TR90 Clip On Phân Cực Polarized 2 Trong 1 Bộ 5 Kẹp Cao Cấp 2218T</a>
                            </h3>
                        ...
                        <div class="pro-loop-wrap position-relative">
                            ...
                            <div class="pro-loop-image position-relative">
                                ...
                                <a href="/products/kinh-mat-gap-tron-oem-2015" class="pro-loop-image-item d-block">
                                    ...
                                    <picture class="img-hidden-when-hover">
                                        <img class="lazyloaded  rounded-3"
                                             src="../../images/product/kinh_mat/clipon6_polarized-12185.png"
                                             alt=" Kính Râm Cận TR90 Clip On Phân Cực Polarized 2 Trong 1 Bộ 5 Kẹp Cao Cấp 12185 ">
                                    </picture>
                                    <!--Ảnh khi horver vào phẩn "Ô hiển thị"-->
                                    <picture class="img-show-when-hover">
                                        <img class="lazyloaded  rounded-3"
                                             src="../../images/product/kinh_mat/clipon6_polarized-12185_hover.png"
                                             alt=" Kính Râm Cận TR90 Clip On Phân Cực Polarized 2 Trong 1 Bộ 5 Kẹp Cao Cấp 12185 ">
                                    </picture>
                                </a>
                            </div>
                            ...
                            <h3 class="pro-loop-name text-center">
                                <a href="/products/kinh-mat-gap-tron-oem-2015"
                                   title="Kính Râm Cận TR90 Clip On Phân Cực Polarized 2 Trong 1 Bộ 5 Kẹp Cao Cấp 12185">Kính
                                    Râm Cận TR90 Clip On Phân Cực Polarized 2 Trong 1 Bộ 5 Kẹp Cao Cấp 12185</a>
                            </h3>
                        ...
                        <div class="pro-loop-wrap position-relative">
                            ...
                            <div class="pro-loop-image position-relative">
                                ...
                                <a href="/products/kinh-mat-gap-tron-oem-2015" class="pro-loop-image-item d-block">
                                    ...
                                    <picture class="img-hidden-when-hover">
                                        <img class="lazyloaded  rounded-3"
                                             src="../../images/product/kinh_mat/clipon7_polarized-8192.png"
                                             alt=" Kính Râm Cận Clip On 2 Trong 1 Cao Cấp 8192 ">
                                    </picture>
                                    <!--Ảnh khi horver vào phẩn "Ô hiển thị"-->
                                    <picture class="img-show-when-hover">
                                        <img class="lazyloaded  rounded-3"
                                             src="../../images/product/kinh_mat/clipon7_polarized-8192_hover.png"
                                             alt=" Kính Râm Cận Clip On 2 Trong 1 Cao Cấp 8192 ">
                                    </picture>
                                </a>
                            </div>
                            ...
                            <h3 class="pro-loop-name text-center">
                                <a href="/products/kinh-mat-gap-tron-oem-2015"
                                   title="Kính Râm Cận Clip On 2 Trong 1 Cao Cấp 8192">Kính Râm Cận Clip On 2 Trong 1
                                    Cao Cấp 8192</a>
                            </h3>
                            ...
                            <!--hiển thị giá-->
                            <div class="pro-loop-price text-center mt-0">
                                <p class="fw-bold d-inline me-3">500,000 <span> ₫</span></p>
                                <del>800,000 <span> ₫</span></del>
                            </div>
                        ...
                        <div class="pro-loop-wrap position-relative">
                            ...
                            <div class="pro-loop-image position-relative">
                                ...
                                <a href="/products/kinh-mat-gap-tron-oem-2015" class="pro-loop-image-item d-block">
                                    ...
                                    <picture class="img-hidden-when-hover">
                                        <img class="lazyloaded  rounded-3"
                                             src="../../images/product/kinh_mat/clipon8_polarized-2502A.png"
                                             alt=" Kính Râm Cận Thể Thao Dây Đeo TR90 Clip On Phân Cực Polarized 2 Trong 1 Bộ 5 Kẹp Cao Cấp 2502A ">
                                    </picture>
                                    <!--Ảnh khi horver vào phẩn "Ô hiển thị"-->
                                    <picture class="img-show-when-hover">
                                        <img class="lazyloaded  rounded-3"
                                             src="../../images/product/kinh_mat/clipon8_polarized-2502A_hover.png"
                                             alt=" Kính Râm Cận Thể Thao Dây Đeo TR90 Clip On Phân Cực Polarized 2 Trong 1 Bộ 5 Kẹp Cao Cấp 2502A ">
                                    </picture>
                                </a>
                            </div>
                            ...
                            <h3 class="pro-loop-name text-center">
                                <a href="/products/kinh-mat-gap-tron-oem-2015"
                                   title="Kính Râm Cận Thể Thao Dây Đeo TR90 Clip On Phân Cực Polarized 2 Trong 1 Bộ 5 Kẹp Cao Cấp 2502A">Kính
                                    Râm Cận Thể Thao Dây Đeo TR90 Clip On Phân Cực Polarized 2 Trong 1 Bộ 5 Kẹp Cao Cấp
                                    2502A</a>
                            </h3>
                        ...
                        <div class="pro-loop-wrap position-relative">
                            ...
                            <div class="pro-loop-image position-relative">
                                ...
                                <a href="/products/kinh-mat-gap-tron-oem-2015" class="pro-loop-image-item d-block">
                                    ...
                                    <picture class="img-hidden-when-hover">
                                        <img class="lazyloaded  rounded-3"
                                             src="../../images/product/kinh_mat/clipon9_polarized-12158.png"
                                             alt=" Kính Râm Cận TR90 Clip On Phân Cực Polarized 2 Trong 1 Bộ 5 Kẹp Cao Cấp 12158 ">
                                    </picture>
                                    <!--Ảnh khi horver vào phẩn "Ô hiển thị"-->
                                    <picture class="img-show-when-hover">
                                        <img class="lazyloaded  rounded-3"
                                             src="../../images/product/kinh_mat/clipon9_polarized-12158_hover.png"
                                             alt=" Kính Râm Cận TR90 Clip On Phân Cực Polarized 2 Trong 1 Bộ 5 Kẹp Cao Cấp 12158 ">
                                    </picture>
                                </a>
                            </div>
                            ...
                            <h3 class="pro-loop-name text-center">
                                <a href="/products/kinh-mat-gap-tron-oem-2015"
                                   title="Kính Râm Cận TR90 Clip On Phân Cực Polarized 2 Trong 1 Bộ 5 Kẹp Cao Cấp 12158">Kính
                                    Râm Cận TR90 Clip On Phân Cực Polarized 2 Trong 1 Bộ 5 Kẹp Cao Cấp 12158</a>
                            </h3>
                        ...
                        <div class="pro-loop-wrap position-relative">
                            ...
                            <div class="pro-loop-image position-relative">
                                ...
                                <a href="/products/kinh-mat-gap-tron-oem-2015" class="pro-loop-image-item d-block">
                                    ...
                                    <picture class="img-hidden-when-hover">
                                        <img class="lazyloaded  rounded-3"
                                             src="../../images/product/kinh_mat/clipon10_polarized-12184.png"
                                             alt=" Kính Râm Cận TR90 Clip On Phân Cực Polarized 2 Trong 1 Bộ 5 Kẹp Cao Cấp 12184 ">
                                    </picture>
                                    <!--Ảnh khi horver vào phẩn "Ô hiển thị"-->
                                    <picture class="img-show-when-hover">
                                        <img class="lazyloaded  rounded-3"
                                             src="../../images/product/kinh_mat/clipon10_polarized-12184_hover.png"
                                             alt=" Kính Râm Cận TR90 Clip On Phân Cực Polarized 2 Trong 1 Bộ 5 Kẹp Cao Cấp 12184 ">
                                    </picture>
                                </a>
                            </div>
                            ...
                            <h3 class="pro-loop-name text-center">
                                <a href="/products/kinh-mat-gap-tron-oem-2015"
                                   title="Kính Râm Cận TR90 Clip On Phân Cực Polarized 2 Trong 1 Bộ 5 Kẹp Cao Cấp 12184">Kính
                                    Râm Cận TR90 Clip On Phân Cực Polarized 2 Trong 1 Bộ 5 Kẹp Cao Cấp 12184</a>
                            </h3>
                        ...
                        <div class="pro-loop-wrap position-relative">
                            ...
                            <div class="pro-loop-image position-relative">
                                ...
                                <a href="/products/kinh-mat-gap-tron-oem-2015" class="pro-loop-image-item d-block">
                                    ...
                                    <picture class="img-hidden-when-hover">
                                        <img class="lazyloaded  rounded-3"
                                             src="../../images/product/kinh_mat/clipon11_christian-dior-diamond-S4U.png"
                                             alt=" Kính mát Cao Cấp Clip on 2 lớp CHRISTIAN DIOR Diamond S4U ">
                                    </picture>
                                    <!--Ảnh khi horver vào phẩn "Ô hiển thị"-->
                                    <picture class="img-show-when-hover">
                                        <img class="lazyloaded  rounded-3"
                                             src="../../images/product/kinh_mat/clipon11_christian-dior-diamond-S4U_hover.png"
                                             alt=" Kính mát Cao Cấp Clip on 2 lớp CHRISTIAN DIOR Diamond S4U ">
                                    </picture>
                                </a>
                            </div>
                            ...
                            <!--Hiển thị tên thương hiệu-->
                            <div class="pro-loop-brand text-center">
                                <span class="pro-loop-vendor d-block">Dior</span>
                            </div>

                            <!--Hiển thị tên sản phẩm-->
                            <h3 class="pro-loop-name text-center">
                                <a href="/products/kinh-mat-gap-tron-oem-2015"
                                   title="Kính mát Cao Cấp Clip on 2 lớp CHRISTIAN DIOR Diamond S4U">Kính mát Cao
                                    Cấp Clip on 2 lớp CHRISTIAN DIOR Diamond S4U</a>
                            </h3>


                            <!--hiển thị giá-->
                            <div class="pro-loop-price text-center mt-0">
                                <p class="fw-bold d-inline me-3">1,500,000 <span> ₫</span></p>
                                <del>2,000,000<span> ₫</span></del>
                            </div>
                        ...
                        <div class="pro-loop-wrap position-relative">
                            ...
                            <div class="pro-loop-image position-relative">
                                ...
                                <a href="/products/kinh-mat-gap-tron-oem-2015" class="pro-loop-image-item d-block">
                                    ...
                                    <picture class="img-hidden-when-hover">
                                        <img class="lazyloaded  rounded-3"
                                             src="../../images/product/kinh_mat/clipon12_polarized-snapLens-12160.png"
                                             alt=" Kính Râm Cận TR90 Clip On Phân Cực Polarized 2 Trong 1 Bộ 5 Kẹp Snap Lens 12160 ">
                                    </picture>
                                    <!--Ảnh khi horver vào phẩn "Ô hiển thị"-->
                                    <picture class="img-show-when-hover">
                                        <img class="lazyloaded  rounded-3"
                                             src="../../images/product/kinh_mat/clipon12_polarized-snapLens-12160_hover.png"
                                             alt=" Kính Râm Cận TR90 Clip On Phân Cực Polarized 2 Trong 1 Bộ 5 Kẹp Snap Lens 12160 ">
                                    </picture>
                                </a>
                            </div>
                            ...
                            <h3 class="pro-loop-name text-center">
                                <a href="/products/kinh-mat-gap-tron-oem-2015"
                                   title="Kính Râm Cận TR90 Clip On Phân Cực Polarized 2 Trong 1 Bộ 5 Kẹp Snap Lens 12160">Kính
                                    Râm Cận TR90 Clip On Phân Cực Polarized 2 Trong 1 Bộ 5 Kẹp Snap Lens 12160</a>
                            </h3>
                        ...
                        <div class="pro-loop-wrap position-relative">
                            ...
                            <div class="pro-loop-image position-relative">
                                ...
                                <a href="/products/kinh-mat-gap-tron-oem-2015" class="pro-loop-image-item d-block">
                                    ...
                                    <picture class="img-hidden-when-hover">
                                        <img class="lazyloaded  rounded-3"
                                             src="../../images/product/kinh_mat/clipon13_polarized-12183.png"
                                             alt=" Kính Râm Cận TR90 Clip On Phân Cực Polarized 2 Trong 1 Bộ 5 Kẹp Cao Cấp 12183 ">
                                    </picture>
                                    <!--Ảnh khi horver vào phẩn "Ô hiển thị"-->
                                    <picture class="img-show-when-hover">
                                        <img class="lazyloaded  rounded-3"
                                             src="../../images/product/kinh_mat/clipon13_polarized-12183_hover.png"
                                             alt=" Kính Râm Cận TR90 Clip On Phân Cực Polarized 2 Trong 1 Bộ 5 Kẹp Cao Cấp 12183 ">
                                    </picture>
                                </a>
                            </div>
                            ...
                            <h3 class="pro-loop-name text-center">
                                <a href="/products/kinh-mat-gap-tron-oem-2015"
                                   title="Kính Râm Cận TR90 Clip On Phân Cực Polarized 2 Trong 1 Bộ 5 Kẹp Cao Cấp 12183">Kính
                                    Râm Cận TR90 Clip On Phân Cực Polarized 2 Trong 1 Bộ 5 Kẹp Cao Cấp 12183</a>
                            </h3>
                        ...
                        <div class="pro-loop-wrap position-relative">
                            ...
                            <div class="pro-loop-image position-relative">
                                ...
                                <a href="/products/kinh-mat-gap-tron-oem-2015" class="pro-loop-image-item d-block">
                                    ...
                                    <picture class="img-hidden-when-hover">
                                        <img class="lazyloaded  rounded-3"
                                             src="../../images/product/kinh_mat/clipon14_polarized-2146.png"
                                             alt=" Kính Râm Cận TR90 Clip On Phân Cực Polarized 2 Trong 1 Bộ 5 Kẹp Cao Cấp 2146 ">
                                    </picture>
                                    <!--Ảnh khi horver vào phẩn "Ô hiển thị"-->
                                    <picture class="img-show-when-hover">
                                        <img class="lazyloaded  rounded-3"
                                             src="../../images/product/kinh_mat/clipon14_polarized-2146_hover.png"
                                             alt=" Kính Râm Cận TR90 Clip On Phân Cực Polarized 2 Trong 1 Bộ 5 Kẹp Cao Cấp 2146 ">
                                    </picture>
                                </a>
                            </div>
                            ...
                            <h3 class="pro-loop-name text-center">
                                <a href="/products/kinh-mat-gap-tron-oem-2015"
                                   title="Kính Râm Cận TR90 Clip On Phân Cực Polarized 2 Trong 1 Bộ 5 Kẹp Cao Cấp 2146">Kính
                                    Râm Cận TR90 Clip On Phân Cực Polarized 2 Trong 1 Bộ 5 Kẹp Cao Cấp 2146</a>
                            </h3>
                        ...
                        <div class="pro-loop-wrap position-relative">
                            ...
                            <div class="pro-loop-image position-relative">
                                ...
                                <a href="/products/kinh-mat-gap-tron-oem-2015" class="pro-loop-image-item d-block">
                                    ...
                                    <picture class="img-hidden-when-hover">
                                        <img class="lazyloaded  rounded-3"
                                             src="../../images/product/kinh_mat/clipon15_polarized-18023.png"
                                             alt=" Kính Râm Cận Brownline TR90 Clip On Phân Cực Polarized 2 Trong 1 18023 ">
                                    </picture>
                                    <!--Ảnh khi horver vào phẩn "Ô hiển thị"-->
                                    <picture class="img-show-when-hover">
                                        <img class="lazyloaded  rounded-3"
                                             src="../../images/product/kinh_mat/clipon15_polarized-18023_hover.png"
                                             alt=" Kính Râm Cận Brownline TR90 Clip On Phân Cực Polarized 2 Trong 1 18023 ">
                                    </picture>
                                </a>
                            </div>
                            ...
                            <h3 class="pro-loop-name text-center">
                                <a href="/products/kinh-mat-gap-tron-oem-2015"
                                   title="Kính Râm Cận Brownline TR90 Clip On Phân Cực Polarized 2 Trong 1 18023">Kính
                                    Râm Cận Brownline TR90 Clip On Phân Cực Polarized 2 Trong 1 18023</a>
                            </h3>
                        ...
                        <div class="pro-loop-wrap position-relative">
                            ...
                            <div class="pro-loop-image position-relative">
                                ...
                                <a href="/products/kinh-mat-gap-tron-oem-2015" class="pro-loop-image-item d-block">
                                    ...
                                    <picture class="img-hidden-when-hover">
                                        <img class="lazyloaded  rounded-3"
                                             src="../../images/product/kinh_mat/clipon16_polarized-8188_C2-den-mat-den.png"
                                             alt=" Kính Râm Cận TR90 Clip On 2 Trong 1 Phân Cực Polarized 8188 ">
                                    </picture>
                                    <!--Ảnh khi horver vào phẩn "Ô hiển thị"-->
                                    <picture class="img-show-when-hover">
                                        <img class="lazyloaded  rounded-3"
                                             src="../../images/product/kinh_mat/clipon16_polarized-8188_C2-den-mat-xanh-reu.png"
                                             alt=" Kính Râm Cận TR90 Clip On 2 Trong 1 Phân Cực Polarized 8188 ">
                                    </picture>
                                </a>
                            </div>
                            ...
                            <h3 class="pro-loop-name text-center">
                                <a href="/products/kinh-mat-gap-tron-oem-2015"
                                   title="Kính Râm Cận TR90 Clip On 2 Trong 1 Phân Cực Polarized 8188">Kính Râm Cận TR90
                                    Clip On 2 Trong 1 Phân Cực Polarized 8188</a>
                            </h3>
                        ...
                        <div class="pro-loop-wrap position-relative">
                            ...
                            <div class="pro-loop-image position-relative">
                                ...
                                <a href="/products/kinh-mat-gap-tron-oem-2015" class="pro-loop-image-item d-block">
                                    ...
                                    <picture class="img-hidden-when-hover">
                                        <img class="lazyloaded  rounded-3"
                                             src="../../images/product/kinh_mat/clipon17_polarized-8191_C2-xanh-reu.png"
                                             alt=" Kính Râm Cận Clip On 2 Trong 1 Cao Cấp 8191 ">
                                    </picture>
                                    <!--Ảnh khi horver vào phẩn "Ô hiển thị"-->
                                    <picture class="img-show-when-hover">
                                        <img class="lazyloaded  rounded-3"
                                             src="../../images/product/kinh_mat/clipon17_polarized-8191_C3-den-trong.png"
                                             alt=" Kính Râm Cận Clip On 2 Trong 1 Cao Cấp 8191 ">
                                    </picture>
                                </a>
                            </div>
                            ...
                            <h3 class="pro-loop-name text-center">
                                <a href="/products/kinh-mat-gap-tron-oem-2015"
                                   title="Kính Râm Cận Clip On 2 Trong 1 Cao Cấp 8191">Kính Râm Cận Clip On 2 Trong 1
                                    Cao Cấp 8191</a>
                            </h3>
                        ...
                        <div class="pro-loop-wrap position-relative">
                            ...
                            <div class="pro-loop-image position-relative">
                                ...
                                <a href="/products/kinh-mat-gap-tron-oem-2015" class="pro-loop-image-item d-block">
                                    ...
                                    <picture class="img-hidden-when-hover">
                                        <img class="lazyloaded  rounded-3"
                                             src="../../images/product/kinh_mat/clipon18_dainel-jones-536.png"
                                             alt=" Kính râm cận 2 lớp clip on daniel jones 536 ">
                                    </picture>
                                    <!--Ảnh khi horver vào phẩn "Ô hiển thị"-->
                                    <picture class="img-show-when-hover">
                                        <img class="lazyloaded  rounded-3"
                                             src="../../images/product/kinh_mat/clipon18_dainel-jones-536_hover.png"
                                             alt=" Kính râm cận 2 lớp clip on daniel jones 536 ">
                                    </picture>
                                </a>
                            </div>
                            ...
                            <!--Hiển thị tên thương hiệu-->
                            <div class="pro-loop-brand text-center">
                                <span class="pro-loop-vendor d-block">daniel jones</span>
                            </div>

                            <!--Hiển thị tên sản phẩm-->
                            <h3 class="pro-loop-name text-center">
                                <a href="/products/kinh-mat-gap-tron-oem-2015"
                                   title="Kính râm cận 2 lớp clip on daniel jones 536">Kính râm cận 2 lớp clip on daniel
                                    jones 536</a>
                            </h3>
                            ...
                            <!--hiển thị giá-->
                            <div class="pro-loop-price text-center mt-0">
                                <p class="fw-bold d-inline me-3">320,000<span> ₫</span></p>
                                <del>500,000 <span> ₫</span></del>
                            </div>
                        ...
                        <div class="pro-loop-wrap position-relative">
                            ...
                            <div class="pro-loop-image position-relative">
                                ...
                                <a href="/products/kinh-mat-gap-tron-oem-2015" class="pro-loop-image-item d-block">
                                    ...
                                    <picture class="img-hidden-when-hover">
                                        <img class="lazyloaded  rounded-3"
                                             src="../../images/product/kinh_mat/clipon19_saint-brown-2132_C2-den-vien-vang.png"
                                             alt=" Kính Râm Cận Clip On 2 Trong 1 Saint Brown 2132 ">
                                    </picture>
                                    <!--Ảnh khi horver vào phẩn "Ô hiển thị"-->
                                    <picture class="img-show-when-hover">
                                        <img class="lazyloaded  rounded-3"
                                             src="../../images/product/kinh_mat/clipon19_saint-brown-2132_C3-den.png"
                                             alt=" Kính Râm Cận Clip On 2 Trong 1 Saint Brown 2132 ">
                                    </picture>
                                </a>
                            </div>
                            ...
                            <!--Hiển thị tên thương hiệu-->
                            <div class="pro-loop-brand text-center">
                                <span class="pro-loop-vendor d-block">Saint Brown</span>
                            </div>

                            <!--Hiển thị tên sản phẩm-->
                            <h3 class="pro-loop-name text-center">
                                <a href="/products/kinh-mat-gap-tron-oem-2015"
                                   title="Kính Râm Cận Clip On 2 Trong 1 Saint Brown 2132">Kính Râm Cận Clip On 2 Trong
                                    1 Saint Brown 2132</a>
                            </h3>


                            <!--hiển thị giá-->
                            <div class="pro-loop-price text-center mt-0">
                                <p class="fw-bold d-inline me-3">420,000 <span> ₫</span></p>
                                <del>700,000 <span> ₫</span></del>
                            </div>
