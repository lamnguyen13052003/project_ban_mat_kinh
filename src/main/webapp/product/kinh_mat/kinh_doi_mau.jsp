                                ...
                                <li class="nav-item dropdown pe-lg-5 pe-md-0">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a class="dropdown-item" href="kinh_mat_ngay_va_dem.jsp">Kính
                                            đi ngày và đêm</a></li>
                                        <li><a class="dropdown-item" href="kinh_doi_mau.html">Kính đổi
                                            màu</a></li>
                        ...
                        <div class="pro-loop-wrap position-relative">
                                ...
                                <a href="/products/kinh-mat-gap-tron-oem-2015" class="pro-loop-image-item d-block">
                                    ...
                                    <picture class="img-hidden-when-hover">
                                        <img class="lazyloaded  rounded-3"
                                             src="../../images/product/kinh_mat/doimau1_lapola-a559_c5-doi-mau-khoi.png"
                                             alt=" Kính Mát Phân Cực Đổi Màu Lapola A559 ">
                                    </picture>
                                    <!--Ảnh khi horver vào phẩn "Ô hiển thị"-->
                                    <picture class="img-show-when-hover">
                                        <img class="lazyloaded  rounded-3"
                                             src="../../images/product/kinh_mat/doimau1_lapola-a559_c4-vang.png"
                                             alt=" Kính Mát Phân Cực Đổi Màu Lapola A559 ">
                                    </picture>
                                </a>
                            </div>
                            ...
                            <h3 class="pro-loop-name text-center">
                                <a href="/products/kinh-mat-gap-tron-oem-2015"
                                   title="Kính Mát Phân Cực Đổi Màu Lapola A559">Kính Mát Phân Cực Đổi Màu Lapola
                                    A559</a>
                            </h3>
                        ...
                        <div class="pro-loop-wrap position-relative">
                            ...
                            <div class="pro-loop-image position-relative">
                                ...
                                <a href="/products/kinh-mat-gap-tron-oem-2015" class="pro-loop-image-item d-block">
                                    ...
                                    <picture class="img-hidden-when-hover">
                                        <img class="lazyloaded  rounded-3"
                                             src="../../images/product/kinh_mat/doimau2_lapola-a161bs.png"
                                             alt=" Kính Mát Phân Cực Đổi Màu Lapola A161BS ">
                                    </picture>
                                    <!--Ảnh khi horver vào phẩn "Ô hiển thị"-->
                                    <picture class="img-show-when-hover">
                                        <img class="lazyloaded  rounded-3"
                                             src="../../images/product/kinh_mat/doimau2_lapola-a161bs_hover.png"
                                             alt=" Kính Mát Phân Cực Đổi Màu Lapola A161BS ">
                                    </picture>
                                </a>
                            </div>
                            ...
                            <h3 class="pro-loop-name text-center">
                                <a href="/products/kinh-mat-gap-tron-oem-2015"
                                   title="Kính Mát Phân Cực Đổi Màu Lapola A161BS">Kính Mát Phân Cực Đổi Màu Lapola
                                    A161BS</a>
                            </h3>
