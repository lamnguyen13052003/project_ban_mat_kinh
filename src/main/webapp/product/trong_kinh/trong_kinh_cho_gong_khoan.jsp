...
<head>
    ...
    <title>Tròng chính cho gọng kính khoan</title>
</head>
<body>
<header id="menu">
                                ...
                                <li class="nav-item dropdown pe-lg-5 pe-md-0">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a class="dropdown-item" href="trong_kinh_mau.jsp">Tròng
                                            kính màu</a></li>
                                        <li><a class="dropdown-item"
                                               href="trong_kinh_cho_gong_khoan.html">Tròng kính cho
                                            gọng khoan</a></li>
                                    </ul>
                                </li>
                                <li class="nav-item dropdown pe-lg-5 pe-md-0">
        ...
        <div class="content collection-wrap">
            ...
            <section class="collection-wrap-product-list mt-5">
                <div class="title mb-3">
                    <h3>Tròng kính cho gọng khoan</h3>
                </div>
...
<script src="../../javascript/product/trong_kinh/trong_kinh_cho_gong_khoan.js"></script>
