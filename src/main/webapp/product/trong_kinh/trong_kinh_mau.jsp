                                ...
                                <li class="nav-item dropdown pe-lg-5 pe-md-0">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a class="dropdown-item" href="trong_kinh_doi_mau.jsp">Tròng
                                            kính đổi màu</a></li>
                                        <li><a class="dropdown-item" href="trong_kinh_mau.html">Tròng
                                            kính màu</a></li>
                                        <li><a class="dropdown-item"
...
<script src="../../javascript/product/trong_kinh/trong_kinh_mau.js"></script>
