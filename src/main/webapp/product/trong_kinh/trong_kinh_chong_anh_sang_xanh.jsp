...
<head>
    ...
    <title>Tròng kính chống ánh sáng xanh</title>
</head>
<body>
<header id="menu">
                    ...
                    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar"
                        ...
                        <div class="offcanvas-body">
                            <ul class="navbar-nav m-auto">
                                ...
                                <li class="nav-item dropdown pe-lg-5 pe-md-0">
                                    <a href="trong_kinh.jsp" class="nav-link dropdown-toggle px-4 rounded active"
                                       type="button">
                                        Tròng kính
                                    </a>
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item"
                                               href="trong_kinh_chong_anh_sang_xanh.html">Tròng kính
                                        ...
                                        <li><a class="dropdown-item" href="trong_kinh_mau.jsp">Tròng
                                            kính màu</a></li>
                                        <li><a class="dropdown-item"
                                               href="trong_kinh_cho_gong_khoan.jsp">Tròng kính cho
                                            gọng khoan</a></li>
                                    </ul>
                                </li>
                                <li class="nav-item dropdown pe-lg-5 pe-md-0">
        ...
        <div class="content collection-wrap">
            ...
            <section class="collection-wrap-product-list mt-5">
                <div class="title mb-3">
                    <h3>Tròng kinh chống ánh sáng</h3>
                </div>
...
<script src="../../javascript/product/trong_kinh/trong_kinh_chong_anh_sang_xanh.js"></script>
