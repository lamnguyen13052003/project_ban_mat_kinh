                        ...
                        <div class="offcanvas-body">
                            <ul class="navbar-nav m-auto">
                                ...
                                <li class="nav-item dropdown pe-lg-5 pe-md-0">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item"
                                               href="gong_kinh_tre_em.html">Gọng Kính Trẻ Em</a>
                                        </li>
                                        <li><a class="dropdown-item"
                    ...
                    <div class="pro-loop col rounded-3">
                        ...
                        <div class="pro-loop-wrap position-relative">
                            ...
                            <div class="pro-loop-image position-relative">
                                ...
                                <!--Hiển thị hình ảnh-->
                                <a href="" class="pro-loop-image-item d-block">
...
<script src="../../javascript/product/mat_kinh_tre_em/gong_kinh_tre_em_page.js"></script>
